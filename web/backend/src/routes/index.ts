...
import { createOnboardingRoutes } from '../modules/onboarding/application/onboarding-task.routes';
...
export function createApiRouter(container: Container): Router {
  ...
  router.use('/onboarding', authenticate, writeMethods, createOnboardingRoutes(container, authenticate));
